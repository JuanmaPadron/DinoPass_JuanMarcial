        ...
        Column(
            ...
            if (showLoginForm.value) {
                ...
                UserForm(
                    ...
                    email, password ->
                    Log.d("DinoPass", "Logueando con $email y $password")
                    navController.navigate(Screens.BottomBarScreens.Discover.route)
                ...
                UserForm(
                    isCreateAccount = true
                        ...
                        email, password ->
                    Log.d("DinoPass", "Creando cuenta con $email y $password")
                    navController.navigate(Screens.BottomBarScreens.Discover.route)
